...
📦 Como Usar
1. Instale as dependências: Antes de iniciar, certifique-se de que a biblioteca principal de interface visual gráfica está presente na sua máquina:

bash
pip install customtkinter
2. Execute o Gerenciador: Dentro da pasta do projeto, inicie o arquivo Python padrão:

bash
python config_manager.py
3. Navegue: Apenas selecione o seu modelo favorito, cole sua chave de API e clique em Salvar Modificações. O aplicativo processará para o ambiente nativo e o deixará invisível rodando por debaixo dos panos, pronto para ser consumido pelos seus processos do terminal.
